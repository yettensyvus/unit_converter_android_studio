...
public class volume_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("VOLUME");
        ...
        volumeName=getResources().getStringArray(R.array.volume_string);
        ArrayAdapter<String> adapter= new ArrayAdapter<>(this, R.layout.temp, R.id.textviewid, volumeName);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(volume_activity.this,"Please Fill The Box",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent ab=new Intent(volume_activity.this, AboutActivity.class);
            startActivity(ab);
            return true;
        }
