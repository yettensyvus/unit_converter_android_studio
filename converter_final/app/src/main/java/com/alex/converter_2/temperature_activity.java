...
public class temperature_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("TEMPERATURE");
        ...
        temperatureName=getResources().getStringArray(R.array.temperature_string);
        ArrayAdapter<String> adapter= new ArrayAdapter<>(this, R.layout.temp, R.id.textviewid, temperatureName);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(temperature_activity.this,"Please Fill The Box",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent ab=new Intent(temperature_activity.this, AboutActivity.class);
            startActivity(ab);
            return true;
        }
